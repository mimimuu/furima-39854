class Item < ApplicationRecord
  ...
  validates :selling_price,            presence: true, numericality: { in: 300..9999999, message: "must be greater than or equal to 300"}, format: { with: /\A[0-9]+\z/, message: "not a number"}
